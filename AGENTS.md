...
config/pr-forge-hosts  optional "<scheme>://<host>[:<port>] <token>" entries naming the instance-hosted HTTP forges this home watches; LOCAL, gitignored, firstmate-maintained but human-editable, and NOT inherited by secondmate homes; absent means no such forge URL is accepted; see docs/configuration.md "HTTP forge hosts"
