...
Nobody reads this chat: the captain and the main firstmate see only what is appended to '/tmp/fm-brief-live.SxsFVw/home/state/t-secondmate-projects.status', and a captain-facing sentence that is not appended there has not been sent.
...
Firstmate steers you through durable message files in '/tmp/fm-brief-live.SxsFVw/home/state/t-secondmate-projects.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/tmp/fm-brief-live.SxsFVw/home/state/t-secondmate-projects.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/tmp/fm-brief-live.SxsFVw/home/state/t-secondmate-projects.inbox'/NNN.msg '/tmp/fm-brief-live.SxsFVw/home/state/t-secondmate-projects.inbox'/handled/`.
...
Report only true captain-relevant outcomes or a declared external wait by appending one line:
   `echo "{state}: {one short line}" >> '/tmp/fm-brief-live.SxsFVw/home/state/t-secondmate-projects.status'`
