...
Nobody reads this chat: the captain and the main firstmate see only what is appended to '/tmp/fm-brief-live.SxsFVw/home/state/t-secondmate.status', and a captain-facing sentence that is not appended there has not been sent.
...
Report only true captain-relevant outcomes or a declared external wait by appending one line:
   `echo "{state}: {one short line}" >> '/tmp/fm-brief-live.SxsFVw/home/state/t-secondmate.status'`
