...
1. Set `HERDR_LAB_HELPER='/Users/onyx/.no-mistakes/worktrees/9573b29b9316/01M29CXKPWBHWNJZ2WQH38C2XQ/bin/fm-herdr-lab.sh'` and generate the session name with `HERDR_LAB_SESSION=$("$HERDR_LAB_HELPER" name t-herdr-scout)`.
...
2. Stay inside this worktree; outside it you may write only the paths this brief names: this task's own data directory (`/tmp/fm-brief-live.SxsFVw/home/data/t-herdr-scout/` - the report, evidence, and artifacts), the instruction inbox (`/tmp/fm-brief-live.SxsFVw/home/state/t-herdr-scout.inbox/`, including its `handled/` directory), and the status file (`/tmp/fm-brief-live.SxsFVw/home/state/t-herdr-scout.status`), plus, in a `--herdr-lab` brief, the Herdr session state its helper commands manage.
3. Use gh-axi for GitHub operations and chrome-devtools-axi for browser operations.
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/tmp/fm-brief-live.SxsFVw/home/state/t-herdr-scout.status'`
...
Firstmate steers you through durable message files in '/tmp/fm-brief-live.SxsFVw/home/state/t-herdr-scout.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/tmp/fm-brief-live.SxsFVw/home/state/t-herdr-scout.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/tmp/fm-brief-live.SxsFVw/home/state/t-herdr-scout.inbox'/NNN.msg '/tmp/fm-brief-live.SxsFVw/home/state/t-herdr-scout.inbox'/handled/`.
...
# Definition of done
Write your findings to `/tmp/fm-brief-live.SxsFVw/home/data/t-herdr-scout/report.md`.
