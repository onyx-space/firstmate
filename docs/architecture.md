...
The proof admits one release reading for a contested slot - a single uncontested live claimant, proven on the shared copy and on the slot's own processes rather than on endpoint liveness alone - and refuses in every other combination, including two gone records.
