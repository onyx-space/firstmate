...
Without that baseline, a refusal verdict is preserved untouched and keeps its own label, so a busy-looking pane can never convert an unread composer into a confirmation.
