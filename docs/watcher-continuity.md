...
A dispatch that cannot be made - no registered name, no wire on the machine, or a refused send - leaves the note and its row exactly as a failed archival does: retryable and named on the acknowledgement's own output, never reported as delivered.
